...
class VimDojo:
    ...
    def validate_lesson(self, lesson: Dict) -> tuple[bool, str]:
        ...
        if validation_type == 'file_saved':
            ...
            if self.current_lesson_file.exists():
                return True, "Success! You've learned how to exit Vim."
            return False, "The file wasn't saved. Try again using :wq"
            ...
            if content == lesson['target_content']:
                return True, "Perfect! You completed the task correctly."
            else:
                return False, f"Not quite right. Try again.\nExpected:\n{lesson['target_content']}\n\nGot:\n{content}"
    ...
    def draw_menu(self, stdscr, selected_idx: int):
        ...
        stdscr.addstr(y + 3, 2, "Use UP/DOWN arrows to navigate")

        stdscr.refresh()

    def draw_briefing(self, stdscr, lesson: Dict):
        ...
        y = height - 3
        stdscr.addstr(y, 0, "-" * width)
        stdscr.addstr(y + 1, 2, "Press ENTER to launch Vim", curses.A_BOLD)

        stdscr.refresh()
        stdscr.getch()

    def draw_debrief(self, stdscr, success: bool, message: str):
        ...
        if success:
            ...
            stdscr.addstr(y + 1, 2, "Press ENTER to try again", curses.A_BOLD)
    ...
    def run_lesson(self, stdscr, lesson: Dict):
        ...
        while True:
            # 1. Briefing
            self.draw_briefing(stdscr, lesson)
            ...
            # 4. Debrief
            self.draw_debrief(stdscr, success, message)
